...
const FILTERS = [ALL_FILTER, ...Array.from(new Set(projects.map((p) => p.category)))]
    ...
    <section id="projects" ref={sectionRef}>
      <div className="section">
        <div className="section-header reveal">
          ...
          <p className="section-subtitle">A selection of projects that showcase what I can build.</p>
        </div>
